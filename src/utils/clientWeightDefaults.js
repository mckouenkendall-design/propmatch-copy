...
export const CLIENT_WEIGHT_DEFAULTS = {
  ...
  retail: {
    ...
    items: [
      ...
      { key: 'drive_thru', label: 'Drive-Thru', default: 'low' },
      { key: 'hood_venting', label: 'Hood / Venting', default: 'low' },
      { key: 'grease_trap', label: 'Grease Trap', default: 'low' },
      { key: 'cold_storage', label: 'Cold Storage', default: 'low' },
      { key: 'rear_loading', label: 'Rear Loading', default: 'low' },
      { key: 'outdoor_seating', label: 'Outdoor Seating', default: 'low' },
      { key: 'auto_bay', label: 'Auto Bay', default: 'low' },
      { key: 'building_class', label: 'Building Class', default: 'low' },
      { key: 'other_amenities', label: 'Other Amenities', default: 'low' },
    ],
  },
  industrial_flex: {
    ...
    items: [
      ...
      { key: 'dock_equipment', label: 'Dock Equipment', default: 'low' },
