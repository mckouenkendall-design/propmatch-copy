  ...
  land: {
    ...
    items: [
      ...
      { key: 'flat_level_land', label: 'Flat / Level Land', default: 'normal',
        why: "Sloped land requires grading, retaining walls, and sometimes engineered foundations that add meaningful cost to any development. The steeper the grade, the more it costs to fix. We score a miss here as a significant penalty rather than a dealbreaker because slope is fixable, just expensive." },
      ...
      { key: 'road_surface', label: 'Road Surface', default: 'normal',
        why: "The surface quality of the road leading to a site affects construction logistics, delivery access, and ultimately the appeal of whatever is built there. Paved access is the standard expectation for commercial development. We weight this because upgrading a dirt or gravel road requires coordination with the municipality or private landowners." },
      { key: 'municipal_water', label: 'Municipal Water', default: 'low',
        why: "Municipal water already at the site eliminates the cost and timeline of extending a water main. It's a bonus when it's there, not a penalty when it isn't. Utility extension is buildable into the development budget. We score utility matches as additive rather than penalizing their absence." },
      { key: 'sanitary_sewer', label: 'Sanitary Sewer', default: 'low',
        why: "Sanitary sewer service eliminates the need for a septic system, which has size and soil-type limitations. Like other utilities, its presence is a cost savings, not a hard requirement for all development types. We score this as a bonus rather than penalizing its absence." },
      { key: 'electric', label: 'Electric', default: 'low',
        why: "Electric service at the site saves the cost of extending lines from the nearest utility pole. For large commercial developments, the cost to run service can be significant. We score this as additive because its absence is a cost factor, not a development blocker." },
      { key: 'natural_gas', label: 'Natural Gas', default: 'low',
        why: "Natural gas service matters for developments that rely on gas-fired heating or industrial processes. Many commercial buildings operate fine without it, using electric alternatives. We score this as a bonus because it's a cost factor and a convenience, not a universal requirement." },
      { key: 'fiber_internet', label: 'Fiber / Internet', default: 'low',
        why: "Fiber connectivity at the site is an increasingly valuable amenity for commercial tenants and mixed-use development. Its absence adds the cost of bringing service to the site. We score this as additive because it matters more for some development types than others." },
    ],
  },
  land_residential: {
    ...
    items: [
      { key: 'buildable_developable', label: 'Buildable / Developable', default: 'high',
        why: "A buildable lot has the zoning, soil conditions, and utility access required to pull permits and start construction. A non-buildable lot may require variances, perc tests, or utility extension before any building can happen. We weight this heavily because it's the fundamental question about whether the land can do what your client needs." },
      { key: 'no_wetlands', label: 'No Wetlands', default: 'normal',
      ...
      { key: 'paved_road_access', label: 'Paved Road Access', default: 'normal',
        why: "A paved road to the lot affects construction logistics, daily livability, and the value of whatever is built there. Gravel and dirt roads are common in rural areas but add maintenance burden and can affect lender and insurer requirements. We weight this because road quality is fixed by the surrounding infrastructure." },
      { key: 'municipal_water', label: 'Municipal Water', default: 'low',
        why: "Municipal water service means no well to drill, maintain, or test. Its presence at the lot saves the buyer money upfront and eliminates ongoing water quality concerns. We score this as a bonus rather than penalizing its absence because a well is a buildable alternative for many lots." },
      { key: 'sanitary_sewer', label: 'Sanitary Sewer', default: 'low',
        why: "Sewer service means no septic system to install, which has soil and acreage requirements that not every lot can meet. Its presence simplifies permitting and reduces upfront cost. We score this as a bonus because septic is a viable alternative on the right lot, just more expensive and regulated." },
      { key: 'electric', label: 'Electric', default: 'low',
        why: "Electric service already at the lot reduces the cost of bringing power to a new build. Running utility lines from a distant pole can add meaningful cost depending on the distance. We score this as additive because it's a cost factor, not a development blocker." },
      { key: 'natural_gas', label: 'Natural Gas', default: 'low',
        why: "Natural gas at the lot allows for gas appliances and heating, which some buyers strongly prefer. Its absence means electric or propane alternatives, which have their own cost and convenience tradeoffs. We score this as a bonus because it's a preference rather than a requirement for most residential builds." },
      { key: 'fiber_internet', label: 'Fiber / Internet', default: 'low',
        why: "Fiber internet service at a residential lot is increasingly important for buyers who work from home or want reliable connectivity in a rural or suburban build. Its absence is a growing dealbreaker for some buyers. We score it as additive because it matters significantly to some clients and not at all to others." },
    ],
  },
  single_family: {
