...
export default function NotificationBell() {
  ...
  const sorted = [...notifications].sort((a, b) => new Date(b.created_date) - new Date(a.created_date)).slice(0, 30);
    ...
    <div ref={ref} style={{ position: 'relative' }}>
      <button
        ...
        style={{
          ...
          height: '36px',
          borderRadius: '8px',
          background: open ? 'rgba(0,219,197,0.12)' : 'rgba(255,255,255,0.06)',
          border: `1px solid ${open ? 'rgba(0,219,197,0.3)' : 'rgba(255,255,255,0.1)'}`,
          cursor: 'pointer',
          display: 'flex',
          alignItems: 'center',
        ...
        onMouseEnter={e => {
          e.currentTarget.style.background = 'rgba(0,219,197,0.12)';
          e.currentTarget.style.borderColor = 'rgba(0,219,197,0.3)';
        }}
        onMouseLeave={e => {
          if (!open) {
          ...
          <div style={{ padding: '16px', borderBottom: '1px solid rgba(255,255,255,0.08)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0 }}>
            ...
            {unreadCount > 0 && (
              <button
                ...
                style={{ background: 'none', border: 'none', cursor: 'pointer', fontFamily: "'Inter', sans-serif", fontSize: '12px', color: ACCENT, padding: 0 }}
              >
                Mark all read
              </button>
            )}
            ...
            {sorted.length === 0 ? (
              ...
              <div
                ...
                style={{
                  ...
                  background: n.read ? 'transparent' : 'rgba(0,219,197,0.04)',
              ...
              >
                ...
                <div style={{
                  ...
                  height: '32px',
                  borderRadius: '8px',
                  background: `${TYPE_COLORS[n.type] || ACCENT}20`,
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  flexShrink: 0,
