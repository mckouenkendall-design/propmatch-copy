    ...
    <div style={{ fontFamily: "'Inter', sans-serif", background: '#F9FAFB', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '120px 48px 80px' }}>
        ...
        {[
          ...
          ['Account Responsibility', 'You are responsible for maintaining the security of your account credentials and for all activity that occurs under your account. Notify us immediately at founder.propmatch@gmail.com if you suspect unauthorized access.'],
          ...
          ['Subscription & Billing', 'Paid subscription plans are billed on a recurring basis. You may cancel at any time from your account settings. Refunds are handled on a case-by-case basis — contact founder.propmatch@gmail.com for billing inquiries.'],
          ...
          ['Contact', 'For any questions about these Terms, email us at founder.propmatch@gmail.com.'],
        ].map(([title, body]) => (
