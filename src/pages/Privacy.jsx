    ...
    <div style={{ fontFamily: "'Inter', sans-serif", background: '#F9FAFB', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '120px 48px 80px' }}>
        ...
        {[
          ...
          ['Your Rights', 'You may request access to, correction of, or deletion of your personal data at any time by emailing propmatch.founder@gmail.com. We will respond within 30 days.'],
          ...
          ['Contact', 'Questions about this policy? Email us at propmatch.founder@gmail.com.'],
        ].map(([title, body]) => (
